<head><meta charset="UTF-8"></head><h1 class="heading">第八章、InnoDB的表空间</h1>
<p>标签： MySQL是怎样运行的</p>
<hr>
...
<ul>
<li>
<p><span style="color:red">不要跳着看！</span></p>
</li>
<li>
<p><span style="color:red">不要跳着看！</span></p>
</li>
...
<h2 class="heading">回忆一些旧知识</h2>
<h3 class="heading">页面类型</h3>
...
<h3 class="heading">页面通用部分</h3>
<p>我们前边说过数据页，也就是<code>INDEX</code>类型的页由7个部分组成，其中的两个部分是所有类型的页面都通用的。当然我不能寄希望于你把我说的话都记住，所以在这里重新强调一遍，任何类型的页面都有下边这种通用的结构：</p>
<p></p><figure><img alt="image_1crjupisqne61uer17ikh6l1v8k9.png-44.9kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f33c338667?w=827&amp;h=525&amp;f=png&amp;s=45934"><figcaption></figcaption></figure><p></p>
...
<h3 class="heading">区（extent）的概念</h3>
...
<p></p><figure><img alt="image_1cri1nutcorp5ghf5c7vqagt1j.png-71.4kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f33c4a1c3a?w=662&amp;h=547&amp;f=png&amp;s=73092"><figcaption></figcaption></figure><p></p>
...
<p></p><figure><img alt="image_1crjo0hl4q8u1dkdofe187b10fa9.png-105.2kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f33df9307a?w=826&amp;h=657&amp;f=png&amp;s=107694"><figcaption></figcaption></figure><p></p>
<p>从上图中我们能得到如下信息：</p>
<ul>
<li>
...
<tr>
<td style="text-align:center"><code>FREE_FRAG</code></td>
<td style="text-align:center">有剩余空间的碎片区</td>
</tr>
<tr>
<td style="text-align:center"><code>FULL_FRAG</code></td>
<td style="text-align:center">没有剩余空间的碎片区</td>
</tr>
<tr>
<td style="text-align:center"><code>FSEG</code></td>
...
<p></p><figure><img alt="image_1crre79uq9971bsdj9s1i0j11en8a.png-96.2kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f343654829?w=1086&amp;h=473&amp;f=png&amp;s=98468"><figcaption></figcaption></figure><p></p>
...
<p></p><figure><img alt="image_1crre8tlh1vmqtfipk663l173q97.png-69.1kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f3444b1515?w=694&amp;h=345&amp;f=png&amp;s=70716"><figcaption></figcaption></figure><p></p>
...
<h4 class="heading">XDES Entry链表</h4>
...
<ul>
<li>
<p>当段中数据较少的时候，首先会查看表空间中是否有状态为<code>FREE_FRAG</code>的区，也就是找还有空闲空间的碎片区，如果找到了，那么从该区中取一些零碎的页把数据插进去；否则到表空间下申请一个状态为<code>FREE</code>的区，也就是空闲的区，把该区的状态变为<code>FREE_FRAG</code>，然后从该新申请的区中取一些零碎的页把数据插进去。之后不同的段使用零碎页的时候都会从该区中取，直到该区中没有空闲空间，然后该区的状态就变成了<code>FULL_FRAG</code>。</p>
...
<p></p><figure><img alt="image_1crrehf6i1jsq1j5cubj1mdoh77a4.png-81.6kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f388927e1c?w=777&amp;h=451&amp;f=png&amp;s=83511"><figcaption></figcaption></figure><p></p>
...
<p></p><figure><img alt="image_1crrju0cnji91a2fhv91ijb15hgb1.png-111.4kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f4087c4a56?w=863&amp;h=535&amp;f=png&amp;s=114114"><figcaption></figcaption></figure><p></p>
<p>它的各个部分释义如下：</p>
<ul>
<li>
...
<p>这个字段指的是在<code>NOT_FULL</code>链表中已经使用了多少个页面。下次从<code>NOT_FULL</code>链表分配空闲页面时可以直接根据这个字段的值定位到。而不用从链表中的第一个页面开始遍历着寻找空闲页面。</p>
</li>
<li>
...
<h3 class="heading">各类型页面详细情况</h3>
<p>到现在为止我们已经大概清楚了表空间、段、区、XDES Entry、INODE Entry、各种以<code>XDES Enty</code>为节点的链表的基本概念了，可是总有一种飞在天上不踏实的感觉，每个区对应的<code>XDES Entry</code>结构到底存储在表空间的什么地方？直属于表空间的<code>FREE</code>、<code>FREE_FRAG</code>、<code>FULL_FRAG</code>链表的基节点到底存储在表空间的什么地方？每个段对应的<code>INODE Entry</code>结构到底存在表空间的什么地方？我们前边介绍了每256个连续的区算是一个组，想解决刚才提出来的这些个疑问还得从每个组开头的一些类型相同的页面说起，接下来我们一个页面一个页面的分析，真相马上就要浮出水面了。</p>
<h4 class="heading"><code>FSP_HDR</code>类型</h4>
...
<p></p><figure><img alt="image_1crmfvigk938c8h1hahglr15329.png-146.8kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f4733af475?w=1136&amp;h=553&amp;f=png&amp;s=150353"><figcaption></figcaption></figure><p></p>
...
<tr>
<td style="text-align:center"><code>File Space Header</code></td>
<td style="text-align:center">表空间头部</td>
<td style="text-align:center"><code>112</code>字节</td>
<td style="text-align:center">表空间的一些整体属性信息</td>
</tr>
<tr>
<td style="text-align:center"><code>XDES Entry</code></td>
<td style="text-align:center">区描述信息</td>
<td style="text-align:center"><code>10240</code>字节</td>
<td style="text-align:center">存储本组256个区对应的属性信息</td>
</tr>
<tr>
<td style="text-align:center"><code>Empty Space</code></td>
<td style="text-align:center">尚未使用空间</td>
<td style="text-align:center"><code>5986</code>字节</td>
...
<h5 class="heading">File Space Header部分</h5>
<p>从名字就可以看出来，这个部分是用来存储表空间的一些整体属性的，废话少说，看图：</p>
<p></p><figure><img alt="image_1crrp2qp310rc10fd33ch716hcp.png-148.1kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f47508ede5?w=912&amp;h=557&amp;f=png&amp;s=151647"><figcaption></figcaption></figure><p></p>
...
<tbody>
<tr>
<td style="text-align:center"><code>Space ID</code></td>
<td style="text-align:center"><code>4</code>字节</td>
<td style="text-align:center">表空间的ID</td>
</tr>
<tr>
<td style="text-align:center"><code>Not Used</code></td>
<td style="text-align:center"><code>4</code>字节</td>
<td style="text-align:center">这4个字节未被使用，可以忽略</td>
</tr>
<tr>
...
<tr>
<td style="text-align:center"><code>FREE Limit</code></td>
<td style="text-align:center"><code>4</code>字节</td>
<td style="text-align:center">尚未被初始化的最小页号，大于或等于这个页号的区对应的XDES Entry结构都没有被加入FREE链表</td>
</tr>
<tr>
<td style="text-align:center"><code>Space Flags</code></td>
<td style="text-align:center"><code>4</code>字节</td>
<td style="text-align:center">表空间的一些占用存储空间比较小的属性</td>
</tr>
<tr>
<td style="text-align:center"><code>FRAG_N_USED</code></td>
<td style="text-align:center"><code>4</code>字节</td>
<td style="text-align:center">FREE_FRAG链表中已使用的页面数量</td>
</tr>
<tr>
<td style="text-align:center"><code>List Base Node for FREE List</code></td>
<td style="text-align:center"><code>16</code>字节</td>
<td style="text-align:center">FREE链表的基节点</td>
</tr>
<tr>
<td style="text-align:center"><code>List Base Node for FREE_FRAG List</code></td>
<td style="text-align:center"><code>16</code>字节</td>
<td style="text-align:center">FREE_FREG链表的基节点</td>
</tr>
<tr>
<td style="text-align:center"><code>List Base Node for FULL_FRAG List</code></td>
<td style="text-align:center"><code>16</code>字节</td>
<td style="text-align:center">FULL_FREG链表的基节点</td>
</tr>
<tr>
<td style="text-align:center"><code>Next Unused Segment ID</code></td>
<td style="text-align:center"><code>8</code>字节</td>
<td style="text-align:center">当前表空间中下一个未使用的 Segment ID</td>
</tr>
<tr>
<td style="text-align:center"><code>List Base Node for SEG_INODES_FULL List</code></td>
<td style="text-align:center"><code>16</code>字节</td>
<td style="text-align:center">SEG_INODES_FULL链表的基节点</td>
</tr>
<tr>
<td style="text-align:center"><code>List Base Node for SEG_INODES_FREE List</code></td>
<td style="text-align:center"><code>16</code>字节</td>
...
<th style="text-align:center">占用的空间（单位：bit）</th>
<th style="text-align:center">描述</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center"><code>POST_ANTELOPE</code></td>
<td style="text-align:center">1</td>
<td style="text-align:center">表示文件格式是否大于<code>ANTELOPE</code></td>
</tr>
<tr>
<td style="text-align:center"><code>ZIP_SSIZE</code></td>
<td style="text-align:center">4</td>
<td style="text-align:center">表示压缩页面的大小</td>
</tr>
<tr>
<td style="text-align:center"><code>ATOMIC_BLOBS</code></td>
<td style="text-align:center">1</td>
<td style="text-align:center">表示是否自动把值非常长的字段放到BLOB页里</td>
</tr>
<tr>
<td style="text-align:center"><code>PAGE_SSIZE</code></td>
<td style="text-align:center">4</td>
<td style="text-align:center">页面大小</td>
</tr>
<tr>
<td style="text-align:center"><code>DATA_DIR</code></td>
<td style="text-align:center">1</td>
<td style="text-align:center">表示表空间是否是从默认的数据目录中获取的</td>
</tr>
<tr>
<td style="text-align:center"><code>SHARED</code></td>
<td style="text-align:center">1</td>
<td style="text-align:center">是否为共享表空间</td>
</tr>
<tr>
<td style="text-align:center"><code>TEMPORARY</code></td>
<td style="text-align:center">1</td>
<td style="text-align:center">是否为临时表空间</td>
</tr>
<tr>
<td style="text-align:center"><code>ENCRYPTION</code></td>
<td style="text-align:center">1</td>
<td style="text-align:center">表空间是否加密</td>
</tr>
<tr>
<td style="text-align:center"><code>UNUSED</code></td>
<td style="text-align:center">18</td>
<td style="text-align:center">没有使用到的比特位</td>
</tr>
</tbody>
</table>
<blockquote class="warning"><p>小贴士：
...
<li>
<p><code>SEG_INODES_FREE</code>链表，该链表中的<code>INODE</code>类型的页面都已经仍有空闲空间来存放<code>INODE Entry</code>结构。</p>
</li>
</ul>
<p>由于我们现在还没有详细唠叨<code>INODE</code>类型页，所以等会说过<code>INODE</code>类型的页之后再回过头来看着两个链表。</p>
</li>
</ul>
<h5 class="heading">XDES Entry部分</h5>
...
<h4 class="heading"><code>XDES</code>类型</h4>
...
<p></p><figure><img alt="image_1cs3vmoii1h971aje1iveack1l109.png-149.5kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f475c0ec2a?w=1257&amp;h=599&amp;f=png&amp;s=153052"><figcaption></figcaption></figure><p></p>
...
<h4 class="heading"><code>IBUF_BITMAP</code>类型</h4>
...
<h4 class="heading"><code>INODE</code>类型</h4>
...
<p></p><figure><img alt="image_1d6dlre5mv9sptarvdi68mp8p.png-162.2kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f47b795d71?w=1150&amp;h=539&amp;f=png&amp;s=166109"><figcaption></figcaption></figure><p></p>
...
<tr>
<td style="text-align:center"><code>List Node for INODE Page List</code></td>
<td style="text-align:center">通用链表节点</td>
<td style="text-align:center"><code>12</code>字节</td>
<td style="text-align:center">存储上一个INODE页面和下一个INODE页面的指针</td>
</tr>
<tr>
<td style="text-align:center"><code>INODE Entry</code></td>
<td style="text-align:center">段描述信息</td>
<td style="text-align:center"><code>16128</code>字节</td>
...
<h3 class="heading">Segment Header 结构的运用</h3>
...
<td style="text-align:center">B+树叶子段的头部信息，仅在B+树的根页定义</td>
</tr>
<tr>
<td style="text-align:center"><code>PAGE_BTR_SEG_TOP</code></td>
<td style="text-align:center"><code>10</code>字节</td>
<td style="text-align:center">B+树非叶子段的头部信息，仅在B+树的根页定义</td>
</tr>
</tbody>
</table>
<p>其中的<code>PAGE_BTR_SEG_LEAF</code>和<code>PAGE_BTR_SEG_TOP</code>都占用10个字节，它们其实对应一个叫<code>Segment Header</code>的结构，该结构图示如下：</p>
<p></p><figure><img alt="image_1d6a74gu41fuqcqm1htri771d1k16.png-65.1kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f48c4472a3?w=657&amp;h=326&amp;f=png&amp;s=66694"><figcaption></figcaption></figure><p></p>
<p>各个部分的具体释义如下：</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center"><code>Space ID of the INODE Entry</code></td>
<td style="text-align:center"><code>4</code></td>
<td style="text-align:center">INODE Entry结构所在的表空间ID</td>
</tr>
<tr>
<td style="text-align:center"><code>Page Number of the INODE Entry</code></td>
<td style="text-align:center"><code>4</code></td>
<td style="text-align:center">INODE Entry结构所在的页面页号</td>
</tr>
<tr>
<td style="text-align:center"><code>Byte Offset of the INODE Ent</code></td>
<td style="text-align:center"><code>2</code></td>
<td style="text-align:center">INODE Entry结构在该页面中的偏移量</td>
</tr>
</tbody>
</table>
...
<h3 class="heading">真实表空间对应的文件大小</h3>
...
<h3 class="heading">系统表空间的整体结构</h3>
<p>系统表空间与独立表空间的一个非常明显的不同之处就是在表空间开头有许多记录整个系统属性的页面，如图：</p>
<p></p><figure><img alt="image_1csbied27ohe1rgg32gquulplm.png-147.4kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f4911220d8?w=824&amp;h=711&amp;f=png&amp;s=150901"><figcaption></figcaption></figure><p></p>
...
<td style="text-align:center">Insert Buffer Header</td>
<td style="text-align:left">存储Insert Buffer的头部信息</td>
</tr>
<tr>
<td style="text-align:center"><code>4</code></td>
<td style="text-align:center"><code>INDEX</code></td>
<td style="text-align:center">Insert Buffer Root</td>
<td style="text-align:left">存储Insert Buffer的根页面</td>
</tr>
<tr>
<td style="text-align:center"><code>5</code></td>
<td style="text-align:center"><code>TRX_SYS</code></td>
<td style="text-align:center">Transction System</td>
<td style="text-align:left">事务系统的相关信息</td>
</tr>
<tr>
<td style="text-align:center"><code>6</code></td>
<td style="text-align:center"><code>SYS</code></td>
<td style="text-align:center">First Rollback Segment</td>
<td style="text-align:left">第一个回滚段的页面</td>
</tr>
<tr>
<td style="text-align:center"><code>7</code></td>
<td style="text-align:center"><code>SYS</code></td>
<td style="text-align:center">Data Dictionary Header</td>
<td style="text-align:left">数据字典头部信息</td>
</tr>
</tbody>
</table>
...
<h4 class="heading">InnoDB数据字典</h4>
...
<td style="text-align:center">整个InnoDB存储引擎中所有的表的信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_COLUMNS</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的列的信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_INDEXES</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的索引的信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_FIELDS</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的索引对应的列的信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_FOREIGN</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的外键的信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_FOREIGN_COLS</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的外键对应列的信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_TABLESPACES</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的表空间信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_DATAFILES</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的表空间对应文件系统的文件路径信息</td>
</tr>
<tr>
<td style="text-align:center"><code>SYS_VIRTUAL</code></td>
<td style="text-align:center">整个InnoDB存储引擎中所有的虚拟生成列的信息</td>
</tr>
</tbody>
</table>
...
<h5 class="heading">SYS_TABLES表</h5>
...
<td style="text-align:center">表的名称</td>
</tr>
<tr>
<td style="text-align:center"><code>ID</code></td>
<td style="text-align:center">InnoDB存储引擎中每个表都有一个唯一的ID</td>
</tr>
<tr>
<td style="text-align:center"><code>N_COLS</code></td>
<td style="text-align:center">该表拥有列的个数</td>
</tr>
<tr>
<td style="text-align:center"><code>TYPE</code></td>
<td style="text-align:center">表的类型，记录了一些文件格式、行格式、压缩等信息</td>
</tr>
<tr>
<td style="text-align:center"><code>MIX_ID</code></td>
<td style="text-align:center">已过时，忽略</td>
</tr>
<tr>
<td style="text-align:center"><code>MIX_LEN</code></td>
<td style="text-align:center">表的一些额外的属性</td>
</tr>
<tr>
<td style="text-align:center"><code>CLUSTER_ID</code></td>
<td style="text-align:center">未使用，忽略</td>
</tr>
<tr>
<td style="text-align:center"><code>SPACE</code></td>
<td style="text-align:center">该表所属表空间的ID</td>
</tr>
</tbody>
</table>
...
<h5 class="heading">SYS_COLUMNS表</h5>
...
<tbody>
<tr>
<td style="text-align:center"><code>TABLE_ID</code></td>
<td style="text-align:center">该列所属表对应的ID</td>
</tr>
<tr>
<td style="text-align:center"><code>POS</code></td>
<td style="text-align:center">该列在表中是第几列</td>
</tr>
<tr>
<td style="text-align:center"><code>NAME</code></td>
<td style="text-align:center">该列的名称</td>
</tr>
<tr>
<td style="text-align:center"><code>MTYPE</code></td>
<td style="text-align:center">main data type，主数据类型，就是那堆INT、CHAR、VARCHAR、FLOAT、DOUBLE之类的东东</td>
</tr>
<tr>
<td style="text-align:center"><code>PRTYPE</code></td>
<td style="text-align:center">precise type，精确数据类型，就是修饰主数据类型的那堆东东，比如是否允许NULL值，是否允许负数啥的</td>
</tr>
<tr>
<td style="text-align:center"><code>LEN</code></td>
<td style="text-align:center">该列最多占用存储空间的字节数</td>
</tr>
<tr>
<td style="text-align:center"><code>PREC</code></td>
<td style="text-align:center">该列的精度，不过这列貌似都没有使用，默认值都是0</td>
</tr>
</tbody>
</table>
...
<h5 class="heading">SYS_INDEXES表</h5>
...
<tr>
<td style="text-align:center"><code>TABLE_ID</code></td>
<td style="text-align:center">该索引所属表对应的ID</td>
</tr>
<tr>
<td style="text-align:center"><code>ID</code></td>
<td style="text-align:center">InnoDB存储引擎中每个索引都有一个唯一的ID</td>
</tr>
<tr>
<td style="text-align:center"><code>NAME</code></td>
<td style="text-align:center">该索引的名称</td>
</tr>
<tr>
<td style="text-align:center"><code>N_FIELDS</code></td>
<td style="text-align:center">该索引包含列的个数</td>
</tr>
<tr>
<td style="text-align:center"><code>TYPE</code></td>
<td style="text-align:center">该索引的类型，比如聚簇索引、唯一索引、更改缓冲区的索引、全文索引、普通的二级索引等等各种类型</td>
</tr>
<tr>
<td style="text-align:center"><code>SPACE</code></td>
<td style="text-align:center">该索引根页面所在的表空间ID</td>
</tr>
<tr>
<td style="text-align:center"><code>PAGE_NO</code></td>
<td style="text-align:center">该索引根页面所在的页面号</td>
</tr>
<tr>
<td style="text-align:center"><code>MERGE_THRESHOLD</code></td>
<td style="text-align:center">如果页面中的记录被删除到某个比例，就把该页面和相邻页面合并，这个值就是这个比例</td>
</tr>
</tbody>
</table>
...
<h5 class="heading">SYS_FIELDS表</h5>
...
<tbody>
<tr>
<td style="text-align:center"><code>INDEX_ID</code></td>
<td style="text-align:center">该索引列所属的索引的ID</td>
</tr>
<tr>
<td style="text-align:center"><code>POS</code></td>
<td style="text-align:center">该索引列在某个索引中是第几列</td>
</tr>
<tr>
<td style="text-align:center"><code>COL_NAME</code></td>
<td style="text-align:center">该索引列的名称</td>
</tr>
</tbody>
</table>
<p>这个<code>SYS_INEXES</code>表只有一个聚集索引：</p>
...
<h5 class="heading">Data Dictionary Header页面</h5>
...
<p></p><figure><img alt="image_1d6a738dco0sugm14v4ivr1dnnp.png-206.9kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f4a729b67a?w=1154&amp;h=628&amp;f=png&amp;s=211820"><figcaption></figcaption></figure><p></p>
...
<tr>
<td style="text-align:center"><code>Data Dictionary Header</code></td>
<td style="text-align:center">数据字典头部信息</td>
<td style="text-align:center"><code>56</code>字节</td>
<td style="text-align:center">记录一些基本系统表的根页面位置以及InnoDB存储引擎的一些全局信息</td>
</tr>
<tr>
<td style="text-align:center"><code>Segment Header</code></td>
<td style="text-align:center">段头部信息</td>
<td style="text-align:center"><code>10</code>字节</td>
<td style="text-align:center">记录本页面所在段对应的INODE Entry位置信息</td>
</tr>
<tr>
<td style="text-align:center"><code>Empty Space</code></td>
<td style="text-align:center">尚未使用空间</td>
<td style="text-align:center"><code>16272</code>字节</td>
<td style="text-align:center">用于页结构的填充，没啥实际意义</td>
</tr>
<tr>
<td style="text-align:center"><code>File Trailer</code></td>
...
<h5 class="heading">information_schema系统数据库</h5>
...
<pre><code class="hljs bash" lang="bash">mysql&gt; USE information_schema;
Database changed

mysql&gt; SHOW TABLES LIKE <span class="hljs-string">'innodb_sys%'</span>;
+--------------------------------------------+
...
+--------------------------------------------+
10 rows <span class="hljs-keyword">in</span> <span class="hljs-built_in">set</span> (0.00 sec)
...
<h3 class="heading">总结图</h3>
<p>小册微信交流群2群中一个昵称为<code>think</code>同学非常有心的为表空间画了一个全局图，希望能对各位有帮助（这种学习态度实在让我感动😹）：</p>
<p></p><figure><img alt="image_1d9ppsbelendcbb13hghhn18pe9.png-3564.2kB" src="https://user-gold-cdn.xitu.io/2019/5/1/16a739f4a99c9a08?w=6102&amp;h=3476&amp;f=png&amp;s=3649724"><figcaption></figcaption></figure><p></p>
